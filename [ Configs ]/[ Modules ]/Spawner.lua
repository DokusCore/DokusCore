...
_Spawner = {
  ...
  Cutscenes    = {
    ...
    { ID = 3,  City = 'Saint Denis', Coords = { Heading = 73.8,  Start = vec3(1931.3, -1182.4, 42.2),  End = vec3(2535.8, -1147.1, 50.0) } },
    { ID = 4,  City = 'Saint Denis', Coords = { Heading = 173.7, Start = vec3(2068.8, -871.7, 42.2),   End = vec3(2535.8, -1147.1, 50.0) } },
    { ID = 5,  City = 'Valentine',   Coords = { Heading = 261.3, Start = vec3(-844.4, 333.3, 95.6),    End = vec3(-338.0, 741.1, 116.6)  } },
    ...
    { ID = 9,  City = 'Blackwater',  Coords = { Heading = 315.8, Start = vec3(-1618.7, -1015.1, 73.3), End = vec3(-746.2, -1291.7, 43.0)  } },
