...
if _EnableIMaps then
	...
	Citizen.CreateThread(function()
	  ...
	  ActInterior(12290, "Valentine bank", {
	    "val_bank_front_windows",
	    "val_bank_int_curtainsopen"
	  })

	  ActInterior(21250, "Valentine saloon", {
	    "front_windows",
	    "val_saloon_br03_bed",
	    "6_chair_poker_set"
	  })

	  ActInterior(7170, "Valentine jail", {
	    "val_jail_int_walla",
	    "val_jail_int_wallb"
	  })

	  ActInterior(45826, "Valentine general store", {
	  ...
	  ActInterior(63746, "Valentine gun store", {
	  ...
	  ActInterior(51202, "Riverboat", {
	    "korrigan_props_poker"
	  })

	  ActInterior(50690, "Beechers", {
	  ...
	  ActInterior(49154, "Bronte", {
	    "bronte_shutters_open",
	    "bronte_glass_unbreakable"
	  })

	  ActInterior(72706, "Braithwaite mansion", {
	    "bra_mansion_WindowsStatic",
	    "bra_int_bedroom_clean"
	  })

	  ActInterior(74241, "Character creator", {
	    "mp_char_female_mirror"
	  })

	  ActInterior(69122, "Trelawny caravan", {
	    "rho_slum_player_trelawny01_stage_01"
	  })

	  ActInterior(14338, "Aberdeen pig farm", {
	    "abe_farmhouse_chest",
	    "clean_abe",
	    "abe_SP_armoir",
	    "ABE_WORKROOM",
	  ...
	  ActInterior(61442, "Blackwater general store", {
	    "_p_apple01x_dressing",
	    "_p_apple01x_dressing",
	    "_p_carrots_01x_dressing",
	    "_p_carrots_01x_group",
	  ...
	  ActInterior(258, "Rhodes general store", {
	  ...
	  ActInterior(8962, "Rhodes gun store", {
	    "p_fireplacelogs02x",
	    "rhoGunsmith_FireON",
	    "RHO_GUN_REGISTER",
	    "_s_inv_arrowammo01x_dressing",
	  ...
	  ActInterior(2050, "Saint Denis gun store", {
	    "_s_inv_arrowammo01x_dressing",
	    "_s_inv_highvlcty_pstAmmo01x_group",
	    "_s_inv_highvlcty_revAmmo01x_group",
	    "_s_inv_highvlcty_rifleAmmo01x_group",
	  ...
	  ActInterior(3074, "Saint Denis general store", {
	    "_p_bread06x_dressing",
	    "_p_bread06x_group",
	    "_p_cigar02x_dressing",
	    "_p_cigar02x_group",
	  ...
	  ActInterior(21506, "Strawberry general store", {
	    "_p_apple01x_dressing",
	    "_p_apple01x_group",
	    "_p_carrots_01x_dressing",
	    "_p_carrots_01x_group",
	  ...
	  ActInterior(42754, "Saint Denis bank", {
	    "new_com_bank_before"
	  })

	  ActInterior(514, "Tumbleweed general store", {
	    "_p_apple01x_dressing",
	    "_p_apple01x_group",
	    "_p_cigarettebox01x_dressing",
	    "_p_cigarettebox01x_group",
	  ...
	  ActInterior(11778, "Tumbleweed gun store", {
	  ...
	  ActInterior(29442, "Rhodes bank", {
	    "rhobank_int_walla"
	  })

	  ActInterior(28418, "Carmody Dell", {
	    "_car_house_int_before_ransack",
	    "_car_house_int_day"
	  })

	  ActInterior(34562, "Saint Denis doctor", {
	    "SD_doc_curtain01",
	    "_s_candyBag01x_red_group",
	    "_s_chocolateBar02x_dressing",
	    "_s_chocolateBar02x_group",
	  ...
	  ActInterior(39938, "Geddes Ranch worker quarters", {
	    "pro_int_shaving",
	    "pro_worker_bedmade",
	    "pro_worker_food",
	  ...
	  ActInterior(26626, "Galarie", {
	    "new_art_photos_pre_RC_Mason",
	    "new_forMyArt_paintings"
	  })

	  ActInterior(72450, "Willards Rest", {
	    "rocky_int_clean"
	  })

	  ActInterior(65282, "Wallace Station general store", {
	    "_p_cigarettebox01x_dressing",
	    "_p_cigarettebox01x_group",
	    "_p_tin_pomade01x_dressing",
	    "_p_tin_pomade01x_group",
	  ...
	  ActInterior(3842, "Armadillo general store", {
	    "_p_cigar02x_dressing",
	    "_p_cigar02x_group",
	    "_p_tin_pomade01x_dressing",
	    "_p_tin_pomade01x_group",
	  ...
	  ActInterior(2818, "Annesburg gun store", {
