...
exports('ShowTopNote', (title, subtext) => {
	const struct1 = new DataView(new ArrayBuffer(48));
	// struct1.setInt32(0, 60000, true); // duration
...
exports('ShowLeftNote', (title, subTitle, dict, icon, duration) => {
	const struct1 = new DataView(new ArrayBuffer(48));
