Lang['fr'] = {
  ...
  ["WorldEdits"] = {
    ...
    ["MexicoBridge1"] = { Gender = false, Time = false, MSG = "Le pont de Mexico"  },
    ["HangingBridge"] = { Gender = false, Time = false, MSG = "Le pont suspendu"   },
    ...
    ["ArthurGraveSt"] = { Gender = false, Time = false, MSG = "Pierre tombale d'Arthur" },
  },
