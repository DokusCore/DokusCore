Lang['pt'] = {
  ...
  ["WorldEdits"] = {
    ...
    ["MexicoBridge1"] = { Gender = false, Time = false, MSG = "A Ponte do México" },
    ["HangingBridge"] = { Gender = false, Time = false, MSG = "A ponte suspensa" },
    ["NakotaNatCamp"]  = { Gender = false, Time = false, MSG = "Nakota Native Camp" },
    ["ApacheNatCamp"] = { Gender = false, Time = false, MSG = "Acampamento nativo Apache" },
    ["LakotaNatCamp"] = { Gender = false, Time = false, MSG = "Lakota Native Camp" },
    ["ArthurGraveSt"] = { Gender = false, Time = false, MSG = "Túmulo de Arthur" },
  },
