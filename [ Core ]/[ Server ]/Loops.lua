...
CreateThread(function() Wait(25000)
  ...
  print("^6----------------------------------------------------------------------------------------")
  Wait(5000)
  print("^3DokusCore is in BETA. Features may not work and core is NOT ready to be used for a live server.")  Wait(1000)
  print("Only use our core for Beta Testing. Also we expect that all beta testers do there best to help")  Wait(1000)
  print("us test all new features. Please report back to us with any information you can share, not only") Wait(1000)
  print("bugs, but also to test all new features. Please report back to us with any information you can") Wait(1000)
  print("share, not only bugs, but also things that run without errors! Try to break the scripts and try") Wait(1000)
  print("to glitch so we can spot possible security flaws. If you have a Beta test license and you are") Wait(1000)
  print("never reporting back to us, we may and will revoke your beta license, and you will lose any") Wait(1000)
  print("perks we might give the testers once we go live. Perks could incluse free premium for some") Wait(1000)
  print("months, special roles in Discord and many more. We appreciate your help and we will show") Wait(1000)
  print("this to you! But if you only request a beta license to get access the server already, ") Wait(1000)
  print("you will lose your license, and possibly get banned from using the core at all!") Wait(1000)
  print("We do our utter best to give you the best quality possible, so we expect some effort from") Wait(1000)
  print("our testers too!") Wait(1000)
  Wait(7000)
  print("^6----------------------------------------------------------------------------------------")
